...
def main():
    ...
    plt.tight_layout()
    out1 = os.path.join(os.path.dirname(__file__), '..', 'results', 'figures', 'hnn_sho_leapfrog_phase_portraits.png')
    ...
    ax.grid(alpha=.3)
    plt.tight_layout()
    out2 = os.path.join(os.path.dirname(__file__), '..', 'results', 'figures', 'hnn_sho_leapfrog_energydrift.png')
