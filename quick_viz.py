...
t, q, p = sho.generateTrajectory(q0 = 1.0, p0 = 0.0, t_span=(0,20) , n_points = 1000)
...
for q0 in [0.5, 1.0, 1.5, 2.0]:
    t, q, p = sho.generateTrajectory(q0 = q0, p0 = 0.0, t_span=(0, 10), n_points = 500)
...
t, q, p = sho.generateTrajectory(q0 = 1.0, p0 = 0.0, t_span=(0,50), n_points = 5000)
